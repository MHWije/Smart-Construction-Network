...
app.controller('FriendSuggestionController',function ($scope,$http){
    $http.get('/connection/friendsuggestions')
        .then(function (res) {
            //if (res.data != "") {
                $scope.workerSuggestions = res.data;
           // }
           // else {
    ...
    $http.get('/connection/newsuggestions')
        .then(function (res) {
            //if (res.data != "") {
                $scope.newSuggestions = res.data;
            //}
            //else {
               // alert("Something went wrong !");
            //}
    ...
    $scope.ViewProfile = function (user_id,worker_id) {
        var url = 'ViewProfile.html?user_id=' + encodeURIComponent(user_id)+'&worker_id='+encodeURIComponent(worker_id);
